...
class Model(nn.Module):
    def __init__(self, arg_dict, device = None):
        ...
        self.fc_left2 = nn.Linear(36 * 10, 96)  # 十人
        self.fc_right2 = nn.Linear(36 * 11, 96)  # 十一人
    ...
    def forward(self, state_dict):
        ...
        left_team_embed = self.norm_left(self.fc_left(left_team_state)) # horizon, batch, n, dim(30, 32, 11-1, 48)
        ...
        left_team_embed = F.relu(self.norm_left2(self.fc_left2(left_team_embed)))                           # (horizon, batch, 96)
        #
    ...
    def make_batch(self, data):
        ...
        s_player_batch, s_ball_batch, s_left_batch, s_left_closest_batch,\
                        s_right_batch, s_right_closest_batch, avail_batch =  [],[],[],[],[],[],[]
        ...
        #
        for rollout in data:
            s_player_lst, s_ball_lst, s_left_lst, s_left_closest_lst,\
                            s_right_lst, s_right_closest_lst, avail_lst =  [], [], [], [], [], [], []
